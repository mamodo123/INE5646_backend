...
const crypto = require('crypto'); // NOVO: Módulo crypto para MD5
...
// NOVO: String aleatória e difícil para concatenar com a senha antes do MD5
// Em um cenário real, isso deveria ser uma variável de ambiente MUITO LONGA e secreta.
...
const hashPasswordWithMD5 = (password) => {
  // Concatena a senha com a string aleatória e hasheia com MD5
...
userSchema.pre('save', async function(next) {
  if (this.isModified('password')) {
    this.password = hashPasswordWithMD5(this.password); // Usa a nova função de hash MD5
  }
  next();
});
